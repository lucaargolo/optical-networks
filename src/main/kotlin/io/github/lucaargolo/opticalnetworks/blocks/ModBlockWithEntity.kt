...
class ModBlockWithEntity<T: BlockEntity>: ModBlock {
    ...
    constructor(block: NetworkConnectableWithEntity) : super(block) {
        this.entity = BlockEntityType.Builder.create(Supplier { block.createBlockEntity(null) }, block).build(null) as BlockEntityType<T>
    }

    constructor(block: NetworkConnectableWithEntity, blockEntityRenderer: KClass<*>) : super(block) {
        this.entity = BlockEntityType.Builder.create(Supplier { block.createBlockEntity(null) }, block).build(null) as BlockEntityType<T>
        this.renderer = blockEntityRenderer as KClass<BlockEntityRenderer<T>>
    }

    constructor(block: NetworkConnectableWithEntity, blockEntityRenderer: KClass<*>, blockEntityScreenHandler: KClass<*>, blockEntityScreen: KClass<*>, customBlockItem: KClass<*>) : super(block) {
        this.entity = BlockEntityType.Builder.create(Supplier { block.createBlockEntity(null) }, block).build(null) as BlockEntityType<T>
        this.renderer = blockEntityRenderer as KClass<BlockEntityRenderer<T>>
    ...
    constructor(block: NetworkConnectableWithEntity, blockEntityRenderer: KClass<*>, blockEntityScreenHandler: KClass<*>, blockEntityScreen: KClass<*>) : super(block) {
        this.entity = BlockEntityType.Builder.create(Supplier { block.createBlockEntity(null) }, block).build(null) as BlockEntityType<T>
        this.renderer = blockEntityRenderer as KClass<BlockEntityRenderer<T>>
        this.container = blockEntityScreenHandler as KClass<ScreenHandler>
        this.containerScreen = blockEntityScreen as KClass<HandledScreen<*>>
    ...
    constructor(block: NetworkConnectableWithEntity, blockEntityScreenHandler: KClass<*>, blockEntityScreen: KClass<*>) : super(block) {
        this.entity = BlockEntityType.Builder.create(Supplier { block.createBlockEntity(null) }, block).build(null) as BlockEntityType<T>
        this.container = blockEntityScreenHandler as KClass<ScreenHandler>
        this.containerScreen = blockEntityScreen as KClass<HandledScreen<*>>
    }
